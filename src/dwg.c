  ...
  if (dwg->header.version < R_13b1)
  ...
  else
    {
      if (!dwg->header.num_sections || dwg->header.from_version < R_2004a)
        {
          if (dwg->fhdr.r2004_header.section_map_id)
            dwg->header.num_sections = dwg->fhdr.r2004_header.section_map_id;
          else if (dwg->fhdr.r2004_header.numsections)
            dwg->header.num_sections = dwg->fhdr.r2004_header.numsections + 2;
          else
